...
import static pokemonmaster.PokemonMasterMod.characterPath;
import static pokemonmaster.PokemonMasterMod.makeID;

public class PokemonMaster extends CustomPlayer {
    //Stats
    ...
    //Strings
    private static final String ID = makeID("pokemonmaster"); //This should match whatever you have in the CharacterStrings.json file
    ...
    public static class Enums {
        ...
        @SpireEnum
        public static AbstractPlayer.PlayerClass POKE_MASTER;
        @SpireEnum(name = "POKEMONMASTER_AZURE_COLOR") // These two MUST match. Change it to something unique for your character.
        public static AbstractCard.CardColor CARD_COLOR;
        @SpireEnum(name = "POKEMONMASTER_AZURE_COLOR") @SuppressWarnings("unused")
        public static CardLibrary.LibraryType LIBRARY_COLOR;
    }
    public static final String[] orbTextures = {
            "pokemonmaster/character/animation/Orb/layer1.png",
            "pokemonmaster/character/animation/Orb/layer2.png",
            "pokemonmaster/character/animation/Orb/layer3.png",
            "pokemonmaster/character/animation/Orb/layer4.png",
            "pokemonmaster/character/animation/Orb/layer5.png",
            "pokemonmaster/character/animation/Orb/layer6.png",
            "pokemonmaster/character/animation/Orb/layer1d.png",
            "pokemonmaster/character/animation/Orb/layer2d.png",
            "pokemonmaster/character/animation/Orb/layer3d.png",
            "pokemonmaster/character/animation/Orb/layer4d.png",
            "pokemonmaster/character/animation/Orb/layer5d.png",};
    public PokemonMaster() {
        super(NAMES[0], Enums.POKE_MASTER,
                new CustomEnergyOrb(orbTextures,  "pokemonmaster/character/animation/Orb/vfx.png", null), //Energy Orb
    ...
    public ArrayList<String> getStartingRelics() {
        ...
        //retVal.add(HornCleat.ID);
        retVal.add(Pokeball.ID);
        return retVal;
    }
...
//        for (AbstractCardPack pack : PokemonMasterMod.pokemonTypes) {
...
//    }
    ...
    public List<CutscenePanel> getCutscenePanels() {
        ...
        panels.add(new CutscenePanel("pokemonmaster/scenes/pokemonmaster1.png"));
        panels.add(new CutscenePanel("pokemonmaster/scenes/pokemonmaster2.png"));
        panels.add(new CutscenePanel("pokemonmaster/scenes/pokemonmaster3.png"));
        return panels;
    }
    @Override
