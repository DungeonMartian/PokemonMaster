...
public class OldCemeteryPower extends BasePower {
    public static final String POWER_ID = makeID("OldCemeteryPower");
    ...
    public OldCemeteryPower(AbstractCreature owner, int amount) {
    ...
    public AbstractPower makeCopy() {
        return new OldCemeteryPower(owner, amount);
    }
}