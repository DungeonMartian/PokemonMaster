...
public class DestructiveFlames extends BasePower implements CloneablePowerInterface {
    public static final String POWER_ID = makeID("DestructiveFlames");
    ...
    public DestructiveFlames(AbstractCreature owner, int amount) {
    ...
    public AbstractPower makeCopy() {
        return new DestructiveFlames(owner, amount);
    }
}