...
import pokemonmaster.powers.MorpekoPower;
import pokemonmaster.util.CardInfo;

import static pokemonmaster.PokemonMasterMod.makeID;

public class Morpeko extends BaseCard {
    ...
    private static final int MORBLOCK= 1;
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        addToBot(new ApplyPowerAction(p, p, new MorpekoPower(p,1)));
